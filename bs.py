...
from bsSpaz import SpazFactory, RespawnIcon, Spaz, PlayerSpaz, \
    ...
    PirateBotNoTimeLimit, PirateBotShielded, PenguinBot, BomberTNTBot, SantaBot, \
    ZombieBot, CallingBot, SkeletonBot, FlyMessage
from bsVector import Vector
from bsSomething import Something, BuildBlock, MagicGenerator, FloatingLandMine
from bsBaseAttack import BaseBlock, BaseDestroyedMessage
from bsFallout import atomicBlast
from TestFloatingBotMod import FlyBot
from botMod import Bot

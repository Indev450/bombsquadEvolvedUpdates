...
values = {
    ...
    'achievements':{
        ...
        'Angry Boss Fight completed':{
            'description':'Complete Angry Boss Fight',
            'descriptionComplete':'Completed Angry Boss Fight',
            'descriptionFull':'Complete Angry Boss Fight',
            'descriptionFullComplete':'Completed Angry Boss Fight',
            'name':'Angry, but so weak)'
        },
        'Mad Boss Fight completed':{
            'description':'Complete Mad Boss Fight',
            'descriptionComplete':'Completed Mad Boss Fight',
            'descriptionFull':'Complete Mad Boss Fight',
            'descriptionFullComplete':'Completed Mad Boss Fight',
            'name':'Mad Fight'
        },
        'God Boss Fight completed':{
            'description':'Complete God Boss Fight',
            'descriptionComplete':'Completed God Boss Fight',
            'descriptionFull':'Complete God Boss Fight',
            'descriptionFullComplete':'Completed God Boss Fight',
            'name':'Fight against a God'
        },
        'Super Punch':{
    ...
    'helpWindow':{
        ...
        'ballonNameText':'ballon',
        'ballonDescriptionText':'Explore sky, or fall on your enemies',
        ...
        'FloatingMineNameText':'Floating mine',
        'FloatingMineDescriptionText':'Pick it up to fly!',
        'deathBombNameText':'Bomb Planting',
        'deathBombDescriptionText':'Spawn bomb on player death.',
        'iceImpactBombNameText':'Ice impact bombs',
        'iceImpactBombDescriptionText':'Impact bomb exploding like ice',
        'BlockPowerupNameText':'Lucky-tnt-block',
        'BlockPowerupDescriptionText':'Explode this to open!',
        'invincibleNameText':'Invincible',
        'invincibleDescriptionText':'Gives you invincible on 10 sec.',
        'cineticTrapNameText':'Cinetic trap',
        'cineticTrapDescriptionText':'Don\'t hit, but launch enemies in sky.',
        'weeeNameText':'Explosion in box',
        'weeeDescriptionText':'Weeeeeeeeee!',
        'smokeBombPowerupNameText':'Smoke bomb',
        'smokeBombPowerupDescriptionText':'The most useless thing in the game',

...
values = {
    ...
    'translations':{
        ...
        'coopLevelNames':{
            ...
            'Rookie ${GAME}':'Amador de ${GAME}',
            'Rookie Football':'Amador de futebol americano',
            'Rookie Onslaught':'Amador de Embate',
            'Runaround':'Evasiva Infinita',
            'The Last Stand':'O Sobrevivente',
            'Uber ${GAME}':'Elite de ${GAME}',
            'Uber Football':'Elite de futebol americano',
            'Uber Onslaught':'Elite de Embate',
            'Uber Runaround':'Elite Evasiva'
        },
        'gameDescriptions':{

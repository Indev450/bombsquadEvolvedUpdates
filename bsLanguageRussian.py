...
values = {
    ...
    'achievements':{
        ...
        'Angry Boss Fight completed':{
            'description':'Завершите Angry Boss Fight',
            'descriptionComplete':'Завершен Angry Boss Fight',
            'descriptionFull':'Завершите Angry Boss Fight',
            'descriptionFullComplete':'Завершен Angry Boss Fight',
            'name':'Зол, но слаб)'
        },
        'Mad Boss Fight completed':{
            'description':'Завершите Mad Boss Fight',
            'descriptionComplete':'Завершен Mad Boss Fight',
            'descriptionFull':'Завершите Mad Boss Fight',
            'descriptionFullComplete':'Завершен Mad Boss Fight',
            'name':'Безумная битва'
        },
        'God Boss Fight completed':{
            'description':'Завершите God Boss Fight',
            'descriptionComplete':'Завершен God Boss Fight',
            'descriptionFull':'Завершите God Boss Fight',
            'descriptionFullComplete':'Завершен God Boss Fight',
            'name':'Сражение с Богом'
        },
        'Super Punch':{
    ...
    'helpWindow':{
        ...
        'ballonDescriptionText':('Исследуй небеса, или\n'
                                      'Падай на своих врагов!'),
        'ballonNameText':'Воздушный шарик ^_^',
        ...
        'FloatingMineNameText':'Летающая мина',
        'FloatingMineDescriptionText':'Подними чтобы полетать!',
        'deathBombNameText':'Установка бомбы',
        'deathBombDescriptionText':'Спавнит бомбу при смерти игрока.',
        'iceImpactBombNameText':'Ледяная бомба-заморозка',
        'iceImpactBombDescriptionText':'Ударная бомба, взрывается как ледяная.',
        'BlockPowerupNameText':'Динамит удачи',
        'BlockPowerupDescriptionText':'Взорви, чтобы открыть!',
        'invincibleNameText':'Неуязвимость.',
        'invincibleDescriptionText':'Дает тебе неуязвимость на 10 секунд.',
        'cineticTrapNameText':'Кинетическая ловушка',
        'cineticTrapDescriptionText':'Не наносит повреждения, но отправляет \n'
                                      'врагов в воздух.',
        'weeeNameText':'Взрыв в коробке',
        'weeeDescriptionText':'Уииииииииии!',
        'smokeBombPowerupNameText':'Дымовая бомба',
        'smokeBombPowerupDescriptionText':'Самая бесполезная бомба в игре.',

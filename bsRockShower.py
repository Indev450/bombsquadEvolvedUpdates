...
def bsGetGames():
    return [RockShowerGame]


def bsGetLevels():
    return [bs.Level('Rock Shower', displayName='${GAME}',
                     gameType=RockShowerGame,
                     settings={}, previewTexName='footballStadiumPreview'),
            bs.Level('Epic Rock Shower', displayName='${GAME}',
                     gameType=RockShowerGame,
                     settings={'Epic Mode': True},
                     previewTexName='footballStadiumPreview')]


class RockShowerGame(bs.TeamGameActivity):
    ...
    def getDescription(cls, sessionType):
        return 'Dodge the falling giant rocks.'
    ...
    def onTransitionIn(self):
        ...
        bsGlobals.tint = (1, 0.7, 1.2)
        bsGlobals.ambientColor = (0,2,2)
    ...
    def _dropBomb(self, position, velocity):
        b = bs.Bomb(bombType='rock', position=position, velocity=velocity).autoRetain()

    def _decrementMeteorTime(self):
        self._meteorTime = max(500, int(self._meteorTime*0.9))
